...
import { filesystemIpcSchema } from './filesystem-schema'
import { agentApiSchema } from './agent-schema'
import { providerApiSchema } from './provider-schema'
import { aiAgentApiSchema } from './ai-agent-schema'
import { deployApiSchema } from './deploy-schema'
import { projectFilesApiSchema } from './project-files-schema'
import { secretsApiSchema } from './secrets-schema'
import { screenshotIpcSchema } from './screenshot-schema'

// Define all IPC channel schemas in one place
// Note: projectApiSchema, userApiSchema, stripeApiSchema, updateApiSchema were removed
